        ...
        if (!src.eof()) {                            // we must have a line
          ...
          switch (op) {
            ...
            case PVM.dsp:
 			case PVM.stlc:		
            case PVM.lda:
			case PVM.ldl: //added case ldl N to this 2 byte address code switch statement
			case PVM.stl: //added case stl N to this 2 byte address opcode switch statement
            case PVM.ldc:
              codeLen = (codeLen + 1) % PVM.memSize;
